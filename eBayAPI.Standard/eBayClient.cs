...
namespace eBayApi
{
    public partial class eBayClient
    {
        ...
        #endregion 设置操作   
        #region 客户端属性
        public OAuth2.OAuth2Client OAuth2 => new OAuth2.OAuth2Client();
        ...
        public Buy.Order.Client BuyOrder => new Buy.Order.Client(_httpClient) { BaseUrl = "https://api.ebay.com/buy/order/v1" };
        ...
        public Sell.Fulfillment.Client SellFulfillment => new Sell.Fulfillment.Client("https://api.ebay.com/sell/fulfillment/v1", _httpClient);
